...
const api = axios.create({
  baseURL: `${import.meta.env.VITE_API_URL || 'https://coffe-back-production-e0b2.up.railway.app/api'}/api`,
  headers: {
    ...
    if (error.response?.status === 401 && !originalRequest._retry) {
      ...
      try {
        ...
        const res = await axios.post(
          `${import.meta.env.VITE_API_URL || 'https://coffe-back-production-e0b2.up.railway.app/api'}/api/refresh-token`,
          {},
